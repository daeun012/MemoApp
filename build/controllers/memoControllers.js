...
module.exports = {
  ...
  readList: function readList(req, res) {
  ...
  readUser: function readUser(req, res) {
    Memo.find({
  ...
  readUserList: function readUserList(req, res) {
    var listType = req.params.listType;
  ...
  star: function star(req, res) {
    ...
    Memo.findById(req.params.id, function (err, memo) {
      ...
      var index = memo.starred.indexOf(req.session.loginInfo.username); // CHECK WHETHER THE USER ALREADY HAS GIVEN A STAR
